/**
 * UI/Components/NpcStore/NpcStoreV1/NpcStoreV1.js (a loja classica de duas
 * janelas com arrasto; desde 01/09/2026 e a RESERVA da NpcStoreV2 -- o
 * controlador em ../NpcStore.js escolhe)
 *
...
import htmlText from './NpcStoreV1.html?raw';
import cssText from './NpcStoreV1.css?raw';

/**
 * Create NPC Store component
 */
const NpcStore = new GUIComponent('NpcStoreV1', cssText);
