...
function init(packetver) {
	...
	// RAGIDLE: custom "Painel de admin" packets (see
	// Network/PacketStructure.js "RAGIDLE:" section). Opcodes 0x0ff6-0x0ff8
	// were free right after 0x0ff3-0x0ff5 above (checked: no other
	// length_list[] assignment in this file touches them).
	...
	// Moved THREE times: 0x0ff3 (config D-337), 0x0ff6 (admin D-338), then
	// 0x0ff9 (skills window D-339): every neighbour shipped first.
	length_list[0x0ffc] = -1; // ZC_RAGIDLE_RELATORIO_OFFLINE (variable, JSON payload)
	...
	// RAGIDLE: o saldo de cash no HUD (28/08/2026). Sai da RESERVA de D-527,
	...
	// 0x0fd6/0x0fd7 em voo na fix/alpha-player-feedback (correio em lote).
	...
	// O MENU LFG (D-634): os tres seguem descendo na faixa reservada de D-527.
