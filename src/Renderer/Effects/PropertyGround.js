...
import _vertexShader from './PropertyGround.vs?raw';
import _fragmentShader from './PropertyGround.fs?raw';
 ...
 */
let _num = 0;
class PropertyGround {
	constructor(position, topSize, bottomSize, height, textureName, tick) {
